 ...
 */
final class Version20200109135033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `references` DROP INDEX UNIQ_9F1E2D9CBCF5E72D, ADD INDEX IDX_9F1E2D9CBCF5E72D (categorie_id)');
        $this->addSql('ALTER TABLE `references` ADD image VARCHAR(255) NOT NULL, DROP image_name, CHANGE create_at created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `references` DROP INDEX IDX_9F1E2D9CBCF5E72D, ADD UNIQUE INDEX UNIQ_9F1E2D9CBCF5E72D (categorie_id)');
        $this->addSql('ALTER TABLE `references` ADD image_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, DROP image, CHANGE created_at create_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE user_coordonnees_id user_coordonnees_id INT DEFAULT NULL, CHANGE abonne_newsletter abonne_newsletter TINYINT(1) DEFAULT \'NULL\', CHANGE confirmation_token confirmation_token TINYINT(1) DEFAULT \'NULL\', CHANGE enabled enabled TINYINT(1) DEFAULT \'NULL\'');
