 ...
 */
final class Version20200109102139 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `references` (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, article_id INT NOT NULL, UNIQUE INDEX UNIQ_9F1E2D9CBCF5E72D (categorie_id), UNIQUE INDEX UNIQ_9F1E2D9C7294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
