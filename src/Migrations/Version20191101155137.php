 ...
 */
final class Version20191101155137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact_email (id INT AUTO_INCREMENT NOT NULL, subject VARCHAR(255) NOT NULL, firstname VARCHAR(25) NOT NULL, lastname VARCHAR(25) NOT NULL, from_email VARCHAR(255) NOT NULL, company VARCHAR(50) DEFAULT NULL, phone_number INT DEFAULT NULL, content LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
