 ...
 */
final class Version20200212110533 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE situation_pro_financiere CHANGE credit_en_cours1_id credit_en_cours1_id INT DEFAULT NULL, CHANGE credit_en_cours2_id credit_en_cours2_id INT DEFAULT NULL, CHANGE credit_en_cours3_id credit_en_cours3_id INT DEFAULT NULL, CHANGE co_acquereur_salaire_mensuel_moyen co_acquereur_salaire_mensuel_moyen INT DEFAULT NULL, CHANGE co_acquereur_revenus_impos co_acquereur_revenus_impos VARCHAR(255) DEFAULT NULL');
