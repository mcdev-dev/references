 ...
 */
final class Version20191209103056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD civilite VARCHAR(20) NOT NULL, ADD last_login DATETIME NOT NULL, ADD registration_date DATETIME NOT NULL, CHANGE abonne_newsletter abonne_newsletter VARCHAR(5) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE article_multi_id article_multi_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user DROP civilite, DROP last_login, DROP registration_date, CHANGE abonne_newsletter abonne_newsletter VARCHAR(5) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
