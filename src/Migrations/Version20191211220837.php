 ...
 */
final class Version20191211220837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_coordonnees ADD avatar VARCHAR(255) DEFAULT NULL, DROP image_name');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE article_multi_id article_multi_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user CHANGE user_coordonnees_id user_coordonnees_id INT DEFAULT NULL, CHANGE abonne_newsletter abonne_newsletter TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user_coordonnees ADD image_name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, DROP avatar');
    }
}
