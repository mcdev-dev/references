 ...
 */
final class Version20200207144004 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE logement_actuel ADD surface_maximale INT NOT NULL, CHANGE logement_actuel logement_actuel VARCHAR(255) NOT NULL, CHANGE logement_recherche logement_recherche LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE montant_loyer montant_loyer INT DEFAULT NULL, CHANGE surface_souhaitee surface_minimale INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE logement_actuel ADD surface_souhaitee INT NOT NULL, DROP surface_minimale, DROP surface_maximale, CHANGE logement_recherche logement_recherche VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE logement_actuel logement_actuel LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\', CHANGE montant_loyer montant_loyer INT DEFAULT NULL');
        $this->addSql('ALTER TABLE media CHANGE article_multi_id article_multi_id INT DEFAULT NULL');
