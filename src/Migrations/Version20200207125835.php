 ...
 */
final class Version20200207125835 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE logement_actuel CHANGE logement_actuel logement_actuel LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE montant_loyer montant_loyer INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE logement_actuel CHANGE montant_loyer montant_loyer INT DEFAULT NULL, CHANGE logement_actuel logement_actuel VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE media CHANGE article_multi_id article_multi_id INT DEFAULT NULL');
