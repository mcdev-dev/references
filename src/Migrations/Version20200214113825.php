 ...
 */
final class Version20200214113825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menage CHANGE civilite civilite VARCHAR(255) DEFAULT NULL, CHANGE nom nom VARCHAR(255) DEFAULT NULL, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE date_naissance date_naissance DATE DEFAULT NULL, CHANGE categorie_socio_pro categorie_socio_pro VARCHAR(255) DEFAULT NULL, CHANGE adresse adresse LONGTEXT DEFAULT NULL, CHANGE code_postal code_postal INT DEFAULT NULL, CHANGE ville ville VARCHAR(255) DEFAULT NULL, CHANGE phone_portable phone_portable VARCHAR(50) DEFAULT NULL, CHANGE phone_domicile phone_domicile VARCHAR(50) DEFAULT NULL, CHANGE phone_pro phone_pro VARCHAR(50) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE situation_familiale situation_familiale VARCHAR(255) DEFAULT NULL, CHANGE taille_foyer taille_foyer VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE interet_habitat_participatif CHANGE motivations motivations LONGTEXT DEFAULT NULL, CHANGE contribution_projet contribution_projet LONGTEXT DEFAULT NULL, CHANGE vie_voisinage vie_voisinage LONGTEXT DEFAULT NULL, CHANGE connaisance_projet connaisance_projet LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE credits_en_cours CHANGE date_debut date_debut DATE NOT NULL, CHANGE date_fin date_fin DATE NOT NULL, CHANGE mensualites mensualites VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE interet_habitat_participatif CHANGE motivations motivations LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE contribution_projet contribution_projet LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE vie_voisinage vie_voisinage LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE connaisance_projet connaisance_projet LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE logement_actuel CHANGE logement_recherche logement_recherche LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\', CHANGE surface_minimale surface_minimale INT NOT NULL, CHANGE surface_maximale surface_maximale INT NOT NULL, CHANGE logement_actuel logement_actuel VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE statut_occupation statut_occupation VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE montant_loyer montant_loyer DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE media CHANGE article_multi_id article_multi_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE menage CHANGE civilite civilite VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nom nom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE prenom prenom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date_naissance date_naissance DATE NOT NULL, CHANGE categorie_socio_pro categorie_socio_pro VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE adresse adresse LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE code_postal code_postal INT NOT NULL, CHANGE ville ville VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE phone_portable phone_portable VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE phone_domicile phone_domicile VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE phone_pro phone_pro VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE situation_familiale situation_familiale VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE taille_foyer taille_foyer VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE situation_pro_financiere CHANGE credit_en_cours1_id credit_en_cours1_id INT DEFAULT NULL, CHANGE credit_en_cours2_id credit_en_cours2_id INT DEFAULT NULL, CHANGE credit_en_cours3_id credit_en_cours3_id INT DEFAULT NULL, CHANGE acquereur_statut_emploi acquereur_statut_emploi VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE acquereur_salaire_mensuel_moyen acquereur_salaire_mensuel_moyen INT NOT NULL, CHANGE acquereur_revenus_impos acquereur_revenus_impos VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE co_acquereur_salaire_mensuel_moyen co_acquereur_salaire_mensuel_moyen INT DEFAULT NULL, CHANGE co_acquereur_revenus_impos co_acquereur_revenus_impos VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE apport_personnel apport_personnel VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
