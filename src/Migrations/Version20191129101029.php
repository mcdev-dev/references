 ...
 */
final class Version20191129101029 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE join_us CHANGE cv_name cv_name VARCHAR(255) DEFAULT NULL, CHANGE lettre_motivation_name lettre_motivation_name VARCHAR(255) DEFAULT NULL, CHANGE book_name book_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE join_us CHANGE cv_name cv_name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE lettre_motivation_name lettre_motivation_name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE book_name book_name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE media CHANGE article_multi_id article_multi_id INT DEFAULT NULL');
